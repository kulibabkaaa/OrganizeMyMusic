...
const envSchema = z.object({
  ...
  AUTH_APPLE_OAUTH_ENABLED: emptyStringToUndefined(z.string().optional()),
  AUTH_GOOGLE_OAUTH_ENABLED: emptyStringToUndefined(z.string().optional()),
  PAYMENTS_ENABLED: emptyStringToUndefined(z.string().optional()),
  PAYMENTS_DEV_BYPASS_ENABLED: emptyStringToUndefined(z.string().optional()),
...
export const env = envSchema.parse({
  ...
  AUTH_APPLE_OAUTH_ENABLED: process.env.AUTH_APPLE_OAUTH_ENABLED,
  AUTH_GOOGLE_OAUTH_ENABLED: process.env.AUTH_GOOGLE_OAUTH_ENABLED,
  PAYMENTS_ENABLED: process.env.PAYMENTS_ENABLED,
  PAYMENTS_DEV_BYPASS_ENABLED: process.env.PAYMENTS_DEV_BYPASS_ENABLED,
