  ...
  return (
    <section className="rounded-[2rem] border border-white/10 bg-white/[0.08] p-7">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-sm uppercase tracking-[0.18em] text-white/42">Latest Sort</p>
      ...
      <p className="mt-3 max-w-2xl text-sm leading-7 text-white/62">
        {latestSortRun
          ? "Open the latest Sort to inspect playlists and decide what should be exported."
        ...
        <>
          <div className="mt-6 grid gap-3 sm:grid-cols-4">
            ...
            <div className="rounded-3xl border border-white/10 bg-black/24 p-4">
              ...
              <p className="mt-1 text-sm text-white/54">tracks reviewed</p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-black/24 p-4">
              <p className="text-2xl font-semibold">{latestSortRun.applePlaylistIdCount}</p>
              <p className="mt-1 text-sm text-white/54">created playlists</p>
            </div>
          </div>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            <span className="text-sm text-white/48">Ready when you are.</span>
          </div>
        </>
      ) : null}
    </section>
