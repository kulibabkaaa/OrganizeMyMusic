    ...
    return (
      <Card className="min-h-96">
        ...
        <p className="mt-2 text-sm leading-7 text-platform-secondary">
          Create one playlist plan before previewing this Sort.
        </p>
      </Card>
    );
  }
    ...
    <Card className="min-w-0 space-y-5">
      <div className="flex flex-col items-start gap-3 sm:flex-row sm:justify-between">
        <div className="min-w-0">
          <StatusPill label="Playlist plan" tone="pink" />
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm text-platform-secondary">
              Add the mood, genre, language, or use-case signals this playlist plan should match.
            </p>
          </div>
          <TagPicker
      ...
      <section className="space-y-4 border-t border-white/10 pt-5">
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-platform-secondary">
            Tune size, duplicate handling, and library constraints after the plan idea is clear.
          </p>
        </div>
