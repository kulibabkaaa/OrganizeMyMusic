    ...
    <Card className="min-w-0 space-y-5">
      ...
      <section className="space-y-4 border-t border-white/10 pt-5">
        <details
          ...
          className="group rounded-[1.25rem] border border-white/10 bg-white/[0.035] p-4"
        >
          <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-sm font-semibold text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-platform-pink">
            <span>
              Advanced settings
              <span className="mt-1 block text-sm font-normal leading-6 text-platform-secondary">
                Tune size, duplicate handling, and library constraints after the playlist idea is clear.
              </span>
            </span>
            <span className="rounded-full border border-white/10 px-3 py-1 text-xs uppercase tracking-[0.16em] text-platform-muted">
